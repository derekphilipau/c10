...
import Swatches from '../images/stock/swatches.jpg';
import Working from '../images/stock/working.jpg';
import Brainstorming from '../images/stock/brainstorming.jpg';


const IndexPage = () => (
    <div className="flex-1 w-100">

      <div className="h-64 bg-black p-8 pt-16 text-center">
      ...
      <div className="flex flex-wrap bg-white mb-8 p-8 pt-16">

        <div className="w-full px-4 mb-8">
          <p className="text-4xl font-hairline text-black">From Our Blog</p>
        </div>

        <div className="w-full md:w-1/3 px-4 mb-8">
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <img classNameName="w-full" src={Swatches} alt="Selecting the right color"/>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">Selecting the right color</div>
        ...
        <div className="w-full md:w-1/3 px-4 mb-8">
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <img classNameName="w-full" src={Brainstorming} alt="Brainstorming Sessions"/>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">Brainstorming Sessions</div>
              <p className="text-grey-darker text-base">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
              </p>
            </div>
        ...
        <div className="w-full md:w-1/3 px-4 mb-8">
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <img classNameName="w-full" src={Working} alt="We work together"/>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">We work together</div>
              <p className="text-grey-darker text-base">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
              </p>
            </div>
